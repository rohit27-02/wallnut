  ...
  return (
    <div style={{ fontFamily: "'Montserrat', sans-serif" }} className='text-[1.5vh] md:text-base'>
      ...
      <div className="w-full justify-center flex flex-col md:flex-row px-[5vh] md:px-[5vw] pt-[72vh] md:pt-[10vw] pb-[5.75vh] md:pb-[5.75vw] bg-[#ecedf2] text-gray-500 ">
        <div className='pr-[2vh] md:pr-[2vw] w-[652.51px]'>
      ...
      <div className='w3r-dot text-[#363f48]'>
        <div className='flex flex-col md:flex-row py-[3.125vh] md:py-[54px] px-[10vw] items-center text-[#363f48]'>
          <p className='text-[4.85vh] md:text-[3.875rem] flex md:flex-col pr-[3.9vh] md:pr-[50px] mr-[3.9vh] md:mr-[50px]  items-center md:items-start gap-[2vh] md:gap-4  md:border-r-[0.15vw] border-[#a58838] font-bold'><span className='text-[#a58838] text-[2.5vh] md:text-2xl italic'>LATEST</span>PROJECTS</p>
        ...
        {/* <div className='h-full w-full'>
          <div className='absolute h-1/3 w-1/4 '>
            <img src='/10.jpg' alt=''/>
          </div>
          <div className='absolute h-1/3 w-1/4 left-[25%]'>
            <img src='/11.jpg' alt=''/>
          </div>
          <div className='absolute h-1/3 w-1/4 left-[50%]'>
            <img src='/13.jpg' alt=''/>
          </div>
          <div className='absolute h-2/3 w-1/4  left-[75%]'>
            <img className='object-cover w-full' src='/12.jpg' alt=''/>
          </div>
          <div className='relative top-[10.8%]'>
          <div className='absolute h-1/3  w-2/4  '>
            <img src='/14.jpg' alt=''/>
          </div>
          <div className='absolute h-1/3 w-1/4  left-[50%]'>
            <img src='/15.jpg' alt=''/>
          ...
          <div className='relative top-[21.6%]'>
          <div className='absolute h-1/3 w-1/4 '>
            <img src='/16.jpg' alt=''/>
          </div>
          <div className='absolute h-1/3 w-1/4 left-[25%]'>
          ...
          <div className='absolute h-[33.3%]  w-2/4 left-[50%] '>
            <img className='w-full' src='/18.jpg' alt=''/>
          </div>
          </div>
        </div> */}
       ...
       <div className='flex flex-col md:flex-row py-[3.125vh] md:py-[54px] px-[10vw] items-center text-[#363f48]'>
          <p className='text-[4.85vh] md:text-[3.875rem] flex md:flex-col pr-[3.9vh] md:pr-[50px] mr-[3.9vh] md:mr-[50px]  items-center md:items-start gap-[2vh] md:gap-4  md:border-r-[0.15vw] border-[#a58838] font-bold'><span className='text-[#a58838] text-[2.5vh] md:text-2xl italic'>OUR</span>FOUNDERS</p>
        ...
        <div className='flex max-sm:flex-wrap items-center justify-center gap-[3vh] md:gap-[6vw]'>
          ...
          <div className='w-[45%] md:w-[262.51px] h-[30vh] md:h-[309.19px] shadow-lg bg-gray-400'>
            <img src='' alt='employee' />
            <div className='text-[1.57vh] md:text-xl font-bold flex justify-center p-[1.25vh] md:p-[15px] bg-white mt-[20vh] md:mt-[260px] w-4/5 mx-auto shadow-lg flex-col items-center'>Manan Mehta<span className='text-[1.25vh] md:text-sm font-normal'>Founder</span></div>
          </div>
          <div className='w-[45%] md:w-[262.51px] h-[30vh] md:h-[309.19px] shadow-lg bg-gray-400'>
            <img src='' alt='employee' />
            <div className='text-[1.57vh] md:text-xl font-bold flex justify-center p-[1.25vh] md:p-[15px] bg-white mt-[20vh] md:mt-[260px] w-4/5 mx-auto shadow-lg flex-col items-center'>Gaurav Jain<span className='text-[1.25vh] md:text-sm font-normal'>Founder</span></div>
          </div>
          <div className='w-[45%] md:w-[262.51px] h-[30vh] md:h-[309.19px] shadow-lg bg-gray-400'>
            <img src='' alt='employee' />
            <div className='text-[1/57vh] md:text-xl font-bold flex justify-center p-[1.25vh] md:p-[15px] bg-white mt-[20vh] md:mt-[260px] w-4/5 mx-auto shadow-lg flex-col items-center'>Yogesh Desai<span className='text-[1.25vh] md:text-sm font-normal'>Founder</span></div>
          </div>
        </div>
      ...
      <div style={{ backgroundImage: `url("/banner.jpg")` }} className='w-full h-[100vh] md:h-[260.66px] bg-center bg-cover'>
        ...
        <div className='flex flex-col text-[2vh] md:text-sm md:flex-row w-full justify-center gap-40 h-full items-center'>
