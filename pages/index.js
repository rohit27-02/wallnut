    ...
    <div style={{ fontFamily: "'Montserrat', sans-serif" }} className='text-[1.5vh] md:text-base'>
        ...
        <div className='pr-[2vh] md:pr-[2vw] md:w-[652.51px]'>
          ...
          <div className='flex md:flex-row justify-between flex-col gap-[2vh] md:gap-[2vw] mt-[2vh] md:mt-[2vw] '>
            <div className='md:w-1/3 w-full'>
              <img loading='lazy' className='w-[5vh] md:w-[3.75rem]' src='https://img.icons8.com/emoji/96/null/house-emoji.png' alt='home-icon2' />
            ...
            <div className='md:w-1/3 w-full'>
              <img loading='lazy' className='w-[5vh] md:w-[3.75rem]' src='https://img.icons8.com/fluency/96/null/shop-department.png' alt='home-icon2' />
            ...
            <div className='md:w-1/3 w-full'>
              <img loading='lazy' className='w-[5vh] md:w-[3.75rem]' src='https://img.icons8.com/emoji/96/null/hotel-emoji.png' alt='home-icon2' />
      ...
      <div className='w3r-dot text-[#363f48]'>
        ...
        <div className='h-[630px] overflow-hidden'>
          ...
          >
            <Masonry className=''>
              <div  className='relative first:[&>*]:hover:h-full first:[&>*]:[&>*]:hover:block'><div className='w-full h-0 bottom-0 transition-all duration-500 ease-in-out absolute bg-black bg-opacity-40 z-20'><span className='text-white h-full p-[20px]  font-bold text-[24px] hidden '>Interior Design<br></br><span className='text-[16px] font-medium'>Design & Consult</span></span></div><img loading='lazy' src='/10.jpeg' alt='' /></div>
              <div  className='relative first:[&>*]:hover:h-full first:[&>*]:[&>*]:hover:block'><div className='w-full h-0 bottom-0 transition-all duration-500 ease-in-out absolute bg-black bg-opacity-40 z-20'><span className='text-white h-full p-[20px]  font-bold text-[24px] hidden '>Interior Design<br></br><span className='text-[16px] font-medium'>Design & Consult</span></span></div><img loading='lazy' src='/12.jpeg' alt='' /></div>
              <div  className='relative first:[&>*]:hover:h-full first:[&>*]:[&>*]:hover:block'><div className='w-full h-0 bottom-0 transition-all duration-500 ease-in-out absolute bg-black bg-opacity-40 z-20'><span className='text-white h-full p-[20px]  font-bold text-[24px] hidden '>Interior Design<br></br><span className='text-[16px] font-medium'>Design & Consult</span></span></div><img loading='lazy' src='/11.jpeg' alt='' /></div>
              <div  className='relative first:[&>*]:hover:h-full first:[&>*]:[&>*]:hover:block'><div className='w-full h-0 bottom-0 transition-all duration-500 ease-in-out absolute bg-black bg-opacity-40 z-20'><span className='text-white h-full p-[20px]  font-bold text-[24px] hidden '>Interior Design<br></br><span className='text-[16px] font-medium'>Design & Consult</span></span></div><img loading='lazy' src='/13.jpeg' alt='' /></div>
              <div  className='relative first:[&>*]:hover:h-full first:[&>*]:[&>*]:hover:block'><div className='w-full h-0 bottom-0 transition-all duration-500 ease-in-out absolute bg-black bg-opacity-40 z-20'><span className='text-white h-full p-[20px]  font-bold text-[24px] hidden '>Interior Design<br></br><span className='text-[16px] font-medium'>Design & Consult</span></span></div><img loading='lazy' src='/14.jpeg' alt='' /></div>
              <div  className='relative first:[&>*]:hover:h-full first:[&>*]:[&>*]:hover:block'><div className='w-full h-0 bottom-0 transition-all duration-500 ease-in-out absolute bg-black bg-opacity-40 z-20'><span className='text-white h-full p-[20px]  font-bold text-[24px] hidden '>Interior Design<br></br><span className='text-[16px] font-medium'>Design & Consult</span></span></div><img loading='lazy' src='/15.png' alt='' /></div>
              <div  className='relative first:[&>*]:hover:h-full first:[&>*]:[&>*]:hover:block'><div className='w-full h-0 bottom-0 transition-all duration-500 ease-in-out absolute bg-black bg-opacity-40 z-20'><span className='text-white h-full p-[20px]  font-bold text-[24px] hidden '>Interior Design<br></br><span className='text-[16px] font-medium'>Design & Consult</span></span></div><img loading='lazy' src='/16.png' alt='' /></div>
              <div  className='relative first:[&>*]:hover:h-full first:[&>*]:[&>*]:hover:block'><div className='w-full h-0 bottom-0 transition-all duration-500 ease-in-out absolute bg-black bg-opacity-40 z-20'><span className='text-white h-full p-[20px]  font-bold text-[24px] hidden '>Interior Design<br></br><span className='text-[16px] font-medium'>Design & Consult</span></span></div><img loading='lazy' src='/17.png' alt='' /></div>
              <div  className='relative first:[&>*]:hover:h-full first:[&>*]:[&>*]:hover:block'><div className='w-full h-0 bottom-0 transition-all duration-500 ease-in-out absolute bg-black bg-opacity-40 z-20'><span className='text-white h-full p-[20px]  font-bold text-[24px] hidden '>Interior Design<br></br><span className='text-[16px] font-medium'>Design & Consult</span></span></div><img loading='lazy' src='/18.png' alt='' /></div>
              <div  className='relative first:[&>*]:hover:h-full first:[&>*]:[&>*]:hover:block'><div className='w-full h-0 bottom-0 transition-all duration-500 ease-in-out absolute bg-black bg-opacity-40 z-20'><span className='text-white h-full p-[20px]  font-bold text-[24px] hidden '>Interior Design<br></br><span className='text-[16px] font-medium'>Design & Consult</span></span></div><img loading='lazy' src='/19.png' alt='' /></div>
              <div  className='relative first:[&>*]:hover:h-full first:[&>*]:[&>*]:hover:block'><div className='w-full h-0 bottom-0 transition-all duration-500 ease-in-out absolute bg-black bg-opacity-40 z-20'><span className='text-white h-full p-[20px]  font-bold text-[24px] hidden '>Interior Design<br></br><span className='text-[16px] font-medium'>Design & Consult</span></span></div><img loading='lazy' src='/20.png' alt='' /></div>
            </Masonry>
          </ResponsiveMasonry>
        </div>
      ...
      <div style={{ backgroundImage: `url("/banner.jpg")` }} className='w-full h-[100vh] md:h-[260.66px]  bg-center bg-cover'>
        ...
        <div className='flex flex-col text-[2vh] md:text-sm md:flex-row w-full justify-center gap-10 md:gap-40 h-full items-center'>
          <div className='flex flex-col z-10 font-bold items-center justify-center'>
            <img loading="lazy" className='w-[5vh] md:w-[60px]' src='https://img.icons8.com/sf-ultralight-filled/200/ffffff/home-page.png' alt="icon" />
            <span className='text-[4.6875vh] md:text-6xl'>1456</span>
            <span>Projects Completed</span>
          </div>
          <div className='flex flex-col z-10 font-bold items-center justify-center'>
            <img loading="lazy" className='w-[5vh] md:w-[60px]' src='https://img.icons8.com/pastel-glyph/200/ffffff/loudspeaker--v2.png' alt="icon" />
            <span className='text-[4.6875vh] md:text-6xl'>432</span>
            <span>Fresh Ideas</span>
          </div>
          <div className='flex flex-col z-10 font-bold items-center justify-center'>
            <img loading="lazy" className='w-[5vh] md:w-[60px]' src='https://img.icons8.com/material-sharp/200/ffffff/conference-call.png' alt="icon" />
            <span className='text-[4.6875vh] md:text-6xl'>992</span>
            <span>Satisfied Clients</span>
          </div>
          <div className='flex flex-col z-10 font-bold items-center justify-center'>
            <img loading="lazy" className='w-[5vh] md:w-[60px]' src='https://img.icons8.com/material-rounded/200/ffffff/tea-cup.png' alt="icon" />
      ...
      <div  className='relative w-full font-bold text-[2.5vh] italic md:text-[24px] h-[24vh] md:h-[302.56px] flex-col flex justify-center items-center text-[#a58838]'>
        <img loading="lazy" className='object-cover w-full opacity-20 h-full absolute top-0' src='/99.png' alt='banner'/>
        TESTIMONIALS
      ...
      <div className='bg-white text-[#363f48] w-full '>
        <div className='w-full  md:h-[545px] flex flex-col-reverse md:flex-row '>
          ...
          <div className='md:w-1/2 h-full overflow-hidden'><img loading='lazy' className='w-full h-full' src='/banner3.jpeg' alt="testimonial" /></div>
        </div>
        <div className='flex flex-col md:flex-row bg-[#ecedf2] h-[400px] text-[#363f48]'>
          <div className='md:w-1/2  flex text-center items-center overflow-hidden'>
            <img loading='lazy' className='w-1/2 h-full' src='/testimonial1.jpg' alt='testimonial2' />
          ...
          <div className='md:w-1/2  flex md:flex-row flex-row-reverse text-center items-center overflow-hidden'>
            <img loading='lazy' className='w-1/2' src='/testimonial2.jpg' alt='testimonial2' />
